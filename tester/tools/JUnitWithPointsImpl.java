...
public abstract class JUnitWithPointsImpl {
	static {
	...
	private static final class ReportEntry {
		...
		private ReportEntry(Description description) {
			this.description = description;
			this.skipped = true;
		}
	...
	public static class PointsLogger extends TestWatcher {
		...
		private boolean isIgnoredCase(Description description) {
		...
		private boolean isSkippedCase(Description description) {
					...
					class InitOnceStatement extends Statement {
						...
						public void evaluate() throws Throwable {
							...
							if (recompute) {
								...
								try {
									final Method initOnceMethod = description.getTestClass().getDeclaredMethod(initOnce.value());
									initOnceMethod.setAccessible(true);
									final Object result = initOnceMethod.invoke(null);
									f.setAccessible(true);
									f.set(null, result);
	...
	public static class PointsSummary extends ExternalResource {
