...
public class ExampleTestcaseParam {
	...
	public static Collection<Integer[]> parameters() {
		Integer[][] runIDs = new Integer[][] { { 1 }, { 2 }, { 3 }, { 4 } };
		return Arrays.asList(runIDs);
	}

	public ExampleTestcaseParam(int runID) {
		this.runID = runID;
	...
	public void before() throws Exception {
		...
		if (m.isAnnotationPresent(Replace.class)) {
			...
			for (Map.Entry<String, SortedSet<String>> e : Factory.mMethsMap
					.entrySet()) {
				String ncln = e.getKey();
				for (String me : e.getValue())
					ncln += "_" + me;
				Factory.mClassMap.put(cl.loadClass(e.getKey()),
						cl.loadClass(ncln));
			}
		}
	}
