...
public class PublicTest {
	...
	public void pubTest_toTest_getSome() {
		assertEquals("Should fail in \"vanilla\" because without @Replace.", 1 + 3, ToTest.toTest_getSome());
	}

	@Test(timeout = 200)
	@Points(exID = "Lambda", bonus = 0.815, comment = "PublicTest: Should fail in \"vanilla\" because without @Replace.")
	public void pubTest_toTest_getSome_int() {
		assertEquals("Should fail in \"vanilla\" because without @Replace.", 2 + 4, new ToTest().toTest_getSome_int(666));
	}
}
