...
public class SecretTest {
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_boolean: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_byte: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_char: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_short: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_int: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_long: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_float: Should pass in \"replaced\" because with @Replace now.")
	...
	@Points(exID = "replace_boxed", bonus = 1, comment = "secTest_toTest_double: Should pass in \"replaced\" because with @Replace now.")
