public class ToTest {
	...
	private int toTest_unnamed_patterns__switch_expressions_helper(Object o) {
		return switch (o) {
			case Tuple2 t2 -> t2.i();
			case Tuple3 _ -> 21; // @Replace should replace wrong student code with expected code here
			default -> -1;
		};
	}
	...
	private int toTest_unnamed_patterns__switch_expressions_multiple_patterns_helper(Object o) {
		return switch (o) {
			case Tuple2 _, Tuple3 _ -> 21; // @Replace should replace wrong student code with expected code here
			default -> -1;
		};
	}
}
