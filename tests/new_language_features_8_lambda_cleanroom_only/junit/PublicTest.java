...
@Exercises({@Ex(exID = "new_language_features_8_lambda_cleanroom_only", points = 47.11)})
public class PublicTest {
	@Points(exID = "new_language_features_8_lambda_cleanroom_only", bonus = 0.815, comment = "PublicTest: Should fail in \"vanilla\" because without @Replace.")
